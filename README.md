...
Selected Criteria
    (1) Master "while" loop for your code that accepts and uses user input.
        Begins a while loop that has the condition that 
    
    (2) Create your own functions (at least 2) and call every function that you made
        I built 8 different functions. One per operator which is six, and a seventh that is a combination of the modulo and floor division.
